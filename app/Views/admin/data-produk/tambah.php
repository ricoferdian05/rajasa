...
<div class="container pt-3">
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="row">
                <!-- ANCHOR CONTENT -->
                <div class="col content ms-2 mt-3 mb-3 ps-3 pe-3 pt-3 pb-2 rounded-3 shadow">
                    <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row text-center">
                                            <div class="col me-3 ms-3">
                                                <div class="row mb-1">
                                                    <img src="<?= base_url('asset/website/image-default.png') ?>" alt="">
                                                </div>
                                                <div class="row">
                                                    <label for="formFileSm" class="form-label" style="color: #707070;">Gambar 1</label>
                                                    <input class="form-control" type="file" name="gambar1" id="gambar1">
                                                </div>
                                            </div>
                                            <div class="col me-3 ms-3">
                                                <div class="row mb-1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input class="form-control" type="file" name="gambar2" id="gambar2">
                                                </div>
                                            </div>
                                            <div class="col me-3 ms-3">
                                                <div class="row mb-1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input class="form-control" type="file" name="gambar3" id="gambar3">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
