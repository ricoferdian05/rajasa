                ...
                <div class="col content ms-2 mt-3 ps-3 pe-3 pt-3 pb-3 rounded-3 shadow">
                    ...
                    <div class="row text-center mt-2 mb-3 ms-3 me-3">
                        <ul class="list-group list-group-horizontal">
                            ...
                            <div class="col">
                                <a href="<?= base_url('designer/transaksi/selesai') ?>">
                                    <li class="list-group-item navbar-transaksi
                            ...
                            <div class="col">
                                <a href="<?= base_url('designer/transaksi/sedang-dikerjakan') ?>">
                                    <li class="list-group-item navbar-transaksi
                            ...
                            <div class="col">
                                <a href="<?= base_url('designer/transaksi/belum-dibayar') ?>">
                                    <li class="list-group-item navbar-transaksi
                        ...
                        <div class="col">
                            <form class="" role="search" action="" method="get">
                                <div class="input-group shadow-sm rounded-2">
                                    <input type="text" name="keyword" class="form-control search-transaksi " placeholder="Cari Nama Customer" value="<?= $keyword; ?>" style="font-size: 10px;">
                        ...
                        <div class="col d-flex flex-row-reverse">
                            <div class="dropdown ms-3">
                                ...
                                <ul class="dropdown-menu dropdown-filter-dashboard-menu">
                                    <li>
                                        <a class="dropdown-item dropdown-filter-dashboard-menu-item" href="<?= base_url('designer/transaksi/' . $kategori) ?>">Semua Tahun</a>
                                    </li>
                                    <?php
                                    ...
                                    ?>
                                            <li>
                                                <a class="dropdown-item dropdown-filter-dashboard-menu-item" href="<?= base_url('designer/transaksi/' . $kategori . '/' . $tahunTransaksi[$x]['tahun']) ?>"><?= $tahunTransaksi[$x]['tahun'] ?></a>
                                            </li>
                                    <?php }
                                    } ?>
                                </ul>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <table class="table table-transaksi caption-top">
                                <caption class="caption-table">Total Data : <?= $jumlahTransaksi; ?></caption>
                                    ...
                                    if (count($transaksi) > 0) {
                                        ...
                                        for ($i = 0; $i < count($transaksi); $i++) { ?>
                                            ...
                                            ?>">
                                                ...
                                                <td><a href="<?= base_url('designer/transaksi/details/' . $transaksi[$i]['id']); ?>" class="btn-detail-transaksi">Detail</a></td>
                                            </tr>
                                    <?php }
                                    }
                                    ?>
