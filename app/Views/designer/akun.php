...
<div class="container pt-3">
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="row">
                <!-- ANCHOR CONTENT -->
                <div class="col content ms-2 mt-3 mb-3 ps-3 pt-4 pb-4 pe-3 rounded-3 shadow">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="<?= base_url('designer/akun/save/' . $akun['id']) ?>" method="post" enctype="multipart/form-data" id="myForm">
                                <center class="mb-3">
