                        ...
                        <div class="col d-flex flex-row-reverse">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-filter-dashboard-menu">
                                    <li>
                                        <a class="dropdown-item dropdown-filter-dashboard-menu-item" href="<?= base_url('designer/dashboard/all/' . $tahunProfit . '/' . $tahunPerformansi); ?>">Semua Tahun</a>
                                    </li>
                                    <?php
                                    ...
                                    ?>
                                            <li>
                                                <a class="dropdown-item dropdown-filter-dashboard-menu-item" href="<?= base_url('designer/dashboard/' . $tahunTransaksi[$x]['tahun'] . '/' . $tahunProfit . '/' . $tahunPerformansi) ?>"><?= $tahunTransaksi[$x]['tahun'] ?></a>
                                            </li>
                                    <?php }
                                    } ?>
                                </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col d-flex flex-row-reverse">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-filter-dashboard-menu">
                                    <li>
                                        <a class="dropdown-item dropdown-filter-dashboard-menu-item" href="<?= base_url('designer/dashboard/' . $tahunKategori . '/all/' . $tahunPerformansi) ?>">Semua Tahun</a>
                                    </li>
                                    <?php
                                    for ($x = 0; $x < count($tahunTransaksi); $x++) {
                                        if ($tahunTransaksi[$x]['tahun'] !== '0') { ?>
                                            <li>
                                                <a class="dropdown-item dropdown-filter-dashboard-menu-item" href="<?= base_url('designer/dashboard/' . $tahunKategori . '/' . $tahunTransaksi[$x]['tahun'] . '/' . $tahunPerformansi) ?>"><?= $tahunTransaksi[$x]['tahun'] ?></a>
                                            </li>
                                    <?php }
                                    } ?>
                                </ul>
            ...
            <div class="row">
                ...
                <div class="col content rounded-3 shadow ms-2 mt-3 ps-3 pe-3 pt-3 pb-3">
                    ...
                    <table class="table table-transaksi-terbaru caption-top">
                        <caption class="caption-table">Total Data : <?= $jumlahTransaksiTerbaru; ?></caption>
                            ...
                            if (count($transaksiTerbaru) > 0) {
                                ...
                                for ($i = 0; $i < count($transaksiTerbaru); $i++) { ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('designer/transaksi/details/' . $transaksiTerbaru[$i]['id']); ?>" class="btn-detail-transaksi-terakhir">Detail</a></td>
                                    </tr>
                            <?php }
                            }
                            ?>
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    enabled: true,
                    padding: 7,
                    backgroundColor: 'rgba(39, 41, 89, .9)',
                    position: 'nearest',
                    yAlign: 'bottom',
                    usePointStyle: true,
                    footerSpacing: 20,
